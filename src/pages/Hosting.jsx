...
export default function Hosting() {
  ...
  const clearImage = useImage((s) => s.clearImage);
  const clearTags = useTags((s) => s.clearTags);
  ...
  return (
    <>
      ...
      <main className="px-35">
        {/* 모바일에서는 1컬럼, lg 이상에서 4컬럼 */}
        <div className="min-h-[calc(100vh-185px)] grid grid-cols-1 lg:grid-cols-4 gap-12 px-6 lg:px-16">
          {/* 왼쪽 큰 영역 */}
          ...
          <div className="lg:col-span-2 flex flex-col justify-center gap-10">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-700">
                  호스팅 초기에 적용할 요금을 설정하고, 세부정보를 인증한
                  <br />
                  다음 리스팅을 게시하세요.
                </p>
              </div>
      ...
      <footer className="fixed bottom-0 left-0 w-full h-[95px] bg-white z-40">
        ...
        <div className="md:px-11 flex items-center justify-between h-[calc(100%-6px)]">
          <button className="border-b-2 cursor-pointer text-sm"></button>

          <button
            className="px-8 py-3 bg-rose-500 rounded-xl text-sm text-white font-bold hover:bg-rose-700"
